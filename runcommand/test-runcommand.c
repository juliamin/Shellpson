...
int main (int argc, char **argv)
{
  ...
  result |=tryrun (args1, 0, NORMAL_TERMINATION, io, EXECOK);   /* Normal, success. */
  result |=tryrun (args2, 2, NORMAL_TERMINATION, io, EXECOK);   /* Normal, failire. */
  result |=tryrun (args3, EXIT_FAILURE, ABNORMAL_TERMINATION, io, EXECOK); /* Abnormal (success). */
  ...
  result |=tryrun (args4, 0, NORMAL_TERMINATION, io2, EXECOK);    /* Normal, success. */

  /* Test whether exec failed. */

  result |=tryrun (args5, 0, 0, io, EXECFAIL);   /* Normal, success. */
